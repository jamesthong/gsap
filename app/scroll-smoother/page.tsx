...
export default function ScrollSmootherPage() {
  ...
  useEffect(() => {
    ...
    // Logo animation
    const paths = gsap.utils.toArray("#logo-scroll path, #logo-smoother path, #logo-mouse");
    const byGreensock = document.querySelector("#by-greensock");
    ...
    // Pin section
    const pinSection = document.querySelector(".pin-section") as HTMLElement;
    const pinContent1 = document.querySelector(".pin-content-1") as HTMLElement;
    const pinContent2 = document.querySelector(".pin-content-2") as HTMLElement;
    ...
    pinTl.fromTo(".pin-content-1", {
      ...
      x: () => -(pinContent1?.offsetWidth || 0),
      ease: "none"
    }, 0)

    pinTl.fromTo(".pin-content-2", {
      x: () => -(pinContent2?.offsetWidth || 0) + document.body.clientWidth * 0.1
    }, {
  ...
  return (
    <div id="smooth-wrapper" ref={wrapperRef} className="bg-black text-white overflow-x-hidden">
      <div id="smooth-content" ref={contentRef}>
        <div className="logo-section h-screen flex items-center justify-center">
          <svg version="1.1" id="scroll-smoother-logo-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 827 238" className="w-3/5">
            <g id="logo-scroll">
              <g id="logo-scroll">
                <path className="scroll-letter" d="M13.2,138.9c0.2-2.2,0.9-4.3,2-6.5c1.2-2.1,2.5-3.9,4.1-5.2c7.4,4.5,14.3,6.7,20.6,6.7c2.9,0,5.2-0.7,6.7-2.1
                ...
                <path className="scroll-letter" d="M100.2,116.3c0-0.3,0-0.6,0-0.9c0-3.8-0.4-6.7-1.2-8.6c-0.8-1.9-2.4-2.9-5-2.9c-2.5,0-4.4,1.2-5.4,3.7
                ...
                <path className="scroll-letter" d="M120,101.2c0.3-1.4,0.9-2.8,1.8-4.4c1-1.6,1.9-2.7,2.9-3.5c6.1,0.6,10.2,3.7,12.4,9.2
                ...
                <path className="scroll-letter" d="M199.4,98.6c4.9,4.9,7.3,11.9,7.3,21c0,9.1-2.4,16.1-7.3,21c-4,4-9.4,6-16,6c-6.7,0-12-2-16-6
                ...
                <path className="scroll-letter" d="M235.4,133.9h3c0.8,2.2,1.2,4.3,1.2,6.3c0,2-0.1,3.5-0.3,4.3c-4.1,0.7-8,1-11.7,1c-3.7,0-6.6-1.1-8.5-3.3
                ...
                <path className="scroll-letter" d="M266.1,133.9h3c0.8,2.2,1.2,4.3,1.2,6.3c0,2-0.1,3.5-0.3,4.3c-4.1,0.7-8,1-11.7,1c-3.7,0-6.6-1.1-8.5-3.3
                c-1.9-2.2-2.9-5.6-2.9-10.4V70.6l0.7-0.7h5.9c3,0,5.1,0.7,6.4,2.1c1.3,1.4,1.9,3.8,1.9,7.1v50
                C261.8,132.3,263.2,133.9,266.1,133.9z" />
              </g>
            </g>
            <g id="by-greensock">
              <path className="by-greensock-letter" d="M291.3,187.6c2.6,0,4.7,1.1,6.1,3.3c1.4,2.2,2.2,5.3,2.2,9.2s-1,6.9-3,9.1c-2,2.1-4.4,3.2-7.2,3.2
        c-2.8,0-5.6-0.5-8.5-1.6v-34.5l0.3-0.3h1.2c0.7,0,1.2,0.2,1.4,0.5c0.2,0.4,0.3,0.9,0.3,1.8v12.4
        C286.3,188.6,288.6,187.6,291.3,187.6z" />
              <path className="by-greensock-letter" d="M323.3,188.2l-6.8,23c-1.2,4.2-2.6,7.2-4,8.9c-1.4,1.7-3.5,2.6-6.2,2.6c-1.3,0-2.6-0.2-3.8-0.6
        ...
        c0.9,3,1.7,5.6,2.4,7.7c0.1,0.2,0.2,0.3,0.5,0.3l6.1-21.9c0.5-0.1,1-0.1,1.6-0.1s1.1,0.1,1.6,0.2L323.3,188.2z" />
              <path className="by-greensock-letter" d="M352.3,195.3h7.4c1,0,1.7,0.2,2.1,0.5c0.4,0.4,0.6,1,0.6,1.9v12.7c-3.5,1.4-7.3,2.2-11.5,2.2
        ...
        c-1.1,0-1.6-0.6-1.6-1.7C352,196.4,352.1,195.9,352.3,195.3z" />
              <path className="by-greensock-letter" d="M369.1,189.5c0.3-0.8,0.8-1.5,1.5-1.9c1.8,0.7,2.9,2.1,3.3,4.4c1.4-2.9,3.6-4.4,6.6-4.4c0.7,0,1.4,0.1,2.2,0.2
        ...
        C370.9,192.4,370.3,190.7,369.1,189.5z" />
              <path className="by-greensock-letter" d="M404.7,201h-15.4c0.2,5.7,2.3,8.6,6.5,8.6c2.3,0,4.7-0.7,7.2-2.1c0.7,0.6,1.1,1.4,1.3,2.4
        ...
        c-1-1.4-2.4-2.2-4.4-2.2c-1.9,0-3.5,0.8-4.5,2.3c-1.1,1.5-1.7,3.6-1.8,6.1h12.2v-0.7C401.4,195.4,400.9,193.6,400,192.1z" />
              <path className="by-greensock-letter" d="M429.3,201h-15.4c0.2,5.7,2.3,8.6,6.5,8.6c2.3,0,4.7-0.7,7.2-2.1c0.7,0.6,1.1,1.4,1.3,2.4
        c-2.6,1.8-5.6,2.7-8.9,2.7c-2.3,0-4.2-0.6-5.7-1.8c-1.5-1.2-2.5-2.7-3.1-4.5c-0.6-1.8-0.9-3.9-0.9-6.3c0-3.7,0.9-6.7,2.6-9
        ...
        c-1-1.4-2.4-2.2-4.4-2.2c-1.9,0-3.5,0.8-4.5,2.3c-1.1,1.5-1.7,3.6-1.8,6.1h12.2v-0.7C426.1,195.4,425.6,193.6,424.6,192.1z" />
              <path className="by-greensock-letter" d="M455,195.1v12.3c0,1.9,0.2,3.3,0.5,4.1c-0.5,0.5-1.2,0.7-2.1,0.7c-1.1,0-1.7-0.7-1.7-2.2v-13.8
        ...
        c2.2,0,3.8,0.7,4.8,2.1C454.5,191,455,192.9,455,195.1z" />
              <path className="by-greensock-letter" d="M461.1,208.9c0.1-1.1,0.7-2,1.7-2.8c3.2,2.3,6.5,3.4,9.8,3.4c2.4,0,4.2-0.5,5.6-1.5c1.4-1,2.1-2.4,2.1-4.1
        ...
        c4.9,2.1,7.3,5,7.3,8.8c0,2.8-1,5.1-2.9,6.8c-1.9,1.7-4.9,2.6-8.9,2.6S464.4,211.3,461.1,208.9z" />
              <path className="by-greensock-letter" d="M509.1,200c0,4.3-1.1,7.7-3.4,10c-1.7,1.7-4,2.6-6.7,2.6s-5-0.9-6.7-2.6c-2.3-2.3-3.4-5.7-3.4-10
        ...
        C503,191,501.3,190,499,190z" />
              <path className="by-greensock-letter" d="M529.3,196.3c0-0.2,0-0.5,0-1c0-0.5-0.1-1.1-0.4-1.9c-0.2-0.8-0.8-1.5-1.6-2.2c-0.9-0.7-1.9-1-3.3-1
        ...
        C530.3,196.5,529.9,196.4,529.3,196.3z" />
              <path className="by-greensock-letter" d="M553.1,203.3l2,4.4c0.8,1.9,1.6,3.1,2.4,3.6c-0.5,0.7-1.2,1-2,1c-0.9,0-1.4-0.2-1.8-0.6
        ...
        c1.1,0.2,2.1,0.7,2.8,1.4C551.8,200.8,552.5,201.9,553.1,203.3z" />
            ...
            <g id="logo-smoother">
              <path className="smoother-letter" d="M276,138.3c0.3-3.2,1.8-5.8,4.3-7.7c6.9,4.5,13.6,6.8,20.1,6.8c4.1,0,7.3-0.9,9.7-2.8c2.4-1.8,3.6-4.2,3.6-7.1
        ...
        C291,145.8,283.2,143.3,276,138.3z" />
              <path className="smoother-letter" d="M359.6,113c0-3.5-0.5-6.1-1.5-7.6c-1-1.5-2.6-2.3-4.7-2.3c-3.8,0-7.6,2.1-11.3,6.4v35
        ...
        c-1.1,0.3-2.7,0.4-4.8,0.4s-3.7-0.1-4.8-0.4V113z" />
              <path className="smoother-letter" d="M440.4,99.4c4.7,4.7,7,11.6,7,20.5s-2.3,15.7-7,20.4c-3.7,3.7-8.5,5.5-14.4,5.5c-5.9,0-10.7-1.8-14.4-5.5
        ...
        s-5.1,0.9-6.8,2.8c-1.8,1.9-3,4.1-3.6,6.7C414.9,113.4,414.6,116.4,414.6,119.9z" />
              <path className="smoother-letter" d="M490.4,99.4c4.7,4.7,7,11.6,7,20.5s-2.3,15.7-7,20.4c-3.7,3.7-8.5,5.5-14.4,5.5c-5.9,0-10.7-1.8-14.4-5.5
        ...
        s-5.1,0.9-6.8,2.8c-1.8,1.9-3,4.1-3.6,6.7C464.9,113.4,464.6,116.4,464.6,119.9z" />
              <path className="smoother-letter" d="M530.8,95.1c0.3,1.1,0.4,2.4,0.4,3.6s-0.1,2.5-0.4,3.5l-12.5-0.1v30.7c0,2.9,1.4,4.3,4.1,4.3h7
        ...
        L530.8,95.1z" />
              <path className="smoother-letter" d="M578.6,110.6v23.6c0,3.9,0.5,6.8,1.6,8.9c-1.7,1.4-3.8,2.1-6.1,2.1c-3.4,0-5.1-2.1-5.1-6.2v-25.9
        ...
        <div className="grid-section">
          <div className="grid-layout">
            <div className="column column-1" data-speed="1.1">
              <div className="column-content">
                <div className="grid-image">
                  <img src="https://picsum.photos/800?random=1" alt="Grid image 1" />
                </div>
                <div className="grid-image">
                  <img src="https://picsum.photos/800?random=2" alt="Grid image 2" />
                </div>
                <div className="grid-image">
                  <img src="https://picsum.photos/800?random=3" alt="Grid image 3" />
                </div>
              </div>
            </div>
            <div className="column column-2" data-speed="1.01">
              <div className="column-content">
                <div className="grid-image">
                  <img src="https://picsum.photos/800?random=4" alt="Grid image 4" />
                </div>
                <div className="grid-image">
                  <img src="https://picsum.photos/800?random=5" alt="Grid image 5" />
                </div>
                <div className="grid-image">
                  <img src="https://picsum.photos/800?random=6" alt="Grid image 6" />
                </div>
              </div>
            </div>
            <div className="column column-3" data-speed="1.1">
              <div className="column-content">
                <div className="grid-image">
                  <img src="https://picsum.photos/800?random=7" alt="Grid image 7" />
                </div>
                <div className="grid-image">
                  <img src="https://picsum.photos/800?random=8" alt="Grid image 8" />
                </div>
                <div className="grid-image">
                  <img src="https://picsum.photos/800?random=9" alt="Grid image 9" />
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="parallax-section">
          <img className="parallax-image" src="https://picsum.photos/800?random=10" data-speed="auto" alt="" />
        </section>
        ...
        <div className="pin-section">
          <div className="pin-content pin-content-1">
            <div className="pin-box">
              <img className="pin-image" src="https://picsum.photos/800?random=11" alt="" />
            </div>
            <div className="pin-box">
              <img className="pin-image" src="https://picsum.photos/800?random=12" alt="" />
            </div>
            <div className="pin-box">
              <img className="pin-image" src="https://picsum.photos/800?random=13" alt="" />
            </div>
          </div>

          <div className="pin-content pin-content-2">
            <div className="pin-box">
              <img className="pin-image" src="https://picsum.photos/800?random=14" alt="" />
            </div>
            <div className="pin-box">
              <img className="pin-image" src="https://picsum.photos/800?random=15" alt="" />
            </div>
            <div className="pin-box">
              <img className="pin-image" src="https://picsum.photos/800?random=16" alt="" />
            </div>
          </div>
        </div>
