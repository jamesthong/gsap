...
export default function ClampPage() {
  ...
  return (
    <>
      ...
      <div ref={wrapperRef} id="smooth-wrapper" className="font-['Unbounded']">
        <div ref={contentRef} id="smooth-content">
          <header className="p-6 flex border-b-2 border-gray-500 bg-gray-900">
            <div className="logo w-[150px] max-w-[40vw] filter invert opacity-0">
            ...
            <nav className="ml-auto">
              <ul role="list" className="flex">
                <li><a href="https://greensock.com/forums/topic/36177-scrollsmoother-data-speed-and-firstlast-folds/#comment-183450" className="text-white">about</a></li>
              </ul>
            </nav>
          </header>

          <section className="hero min-h-screen">
            <div className="heading relative z-2 mix-blend-difference" style={{ perspective: '1000px', backfaceVisibility: 'visible', transform: 'rotate(0.1deg)' }}>
              <div ref={pinRef} className="pin">
                <h1 className="relative text-center uppercase text-8xl">
                  <span className="clamp relative z-[-1]">
                    Clamp
                    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 842.14 500" className="absolute w-[112%] top-1/2 left-[-6%]" style={{ transform: 'translateY(-50%) rotate(2deg)' }}>
            ...
            <div className="images grid grid-cols-4 items-stretch gap-10 justify-items-center mt-8 z-[-1]">
              <img data-speed="clamp(2.4)" src='https://images.unsplash.com/photo-1530569673472-307dc017a82d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2ODM2NTUwMDA&ixlib=rb-4.0.3&q=80&w=400' alt='' className="max-w-full h-[60vh] object-cover" />
              <img data-speed="clamp(1.8)" src='https://images.unsplash.com/photo-1439853949127-fa647821eba0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2ODM2NTQ5Njk&ixlib=rb-4.0.3&q=80&w=400' alt='' className="max-w-full h-[60vh] object-cover" />
              <img data-speed="clamp(2.2)" src='https://images.unsplash.com/photo-1551376347-075b0121a65b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2ODM2NTQ5MTE&ixlib=rb-4.0.3&q=80&w=400' alt='' className="max-w-full h-[60vh] object-cover" />
              <img data-speed="clamp(1.5)" src='https://images.unsplash.com/photo-1500817487388-039e623edc21?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2ODM2NTQ5MTE&ixlib=rb-4.0.3&q=80&w=400' alt='' className="max-w-full h-[60vh] object-cover" />
            </div>
          </section>

          <section className="spacer h-screen">
          </section>
        </div>
      </div>
    </>
