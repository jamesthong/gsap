...
export default function ClampPage() {
  ...
  return (
    <>
      <header className="p-6 flex border-b-2 border-gray-600 bg-gray-900">
        <div className="logo w-[150px] max-w-[40vw] invert">
      ...
      <section className="hero min-h-screen">
        <div className="heading relative z-20 mix-blend-difference" style={{ perspective: '1000px', backfaceVisibility: 'visible', transform: 'rotate(0.1deg)' }}>
          <div className="pin">
            <h1 className="relative text-center uppercase text-6xl md:text-8xl lg:text-9xl">
              <span className="clamp relative -z-10">
                Clamp
                <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 842.14 500" className="absolute w-[112%] top-0 left-0 rotate-[2deg]">
              ...
              <span className="yt z-30">your triggers</span>
            </h1>
          </div>
        </div>
        <div className="images grid grid-cols-4 justify-items-center items-stretch mt-8 -z-10">
