...
export default function ScrollSmootherDemoPage() {
  ...
  return (
    <div ref={wrapperRef} id="wrapper" className="bg-gray-900 text-white font-sans font-light overscroll-none m-0 p-0 overflow-x-hidden">
      <style>{`
      ...
      <section ref={contentRef} id="content">
        ...
        <section className="title container flow--lg">
          <h1><span className="eyebrow" aria-hidden="true">with </span>GSAP scrollsmoother</h1>
